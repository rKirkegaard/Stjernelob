...
extension BadgeCatalogue {
    static let allBadges: [Badge] = [
        ...
        Badge(
            ...
            category: .firstSteps,
            trigger: .completeSessions(count: 1)
        ),
        ...
        Badge(
            ...
            category: .firstSteps,
            trigger: .completeSessions(count: 3)
        ),
        ...
        Badge(
            ...
            trigger: .sessionsInOneWeek(count: 2)
        ),
        ...
        Badge(
            ...
            category: .consistency,
            trigger: .sessionsInOneWeek(count: 3)
        ),
        ...
        Badge(
            ...
            category: .consistency,
            trigger: .returnAfterBreak(minDays: 10)
        ),

        // MARK: Vejr & omgivelser

        Badge(
            slug: "regnvejrsloeber",
            name: "Regnvejrsløber",
            description: "Løb en tur i regnvejr",
            category: .weather,
            trigger: .sessionInRain
        ),
        ...
        Badge(
            ...
            category: .weather,
            trigger: .sessionInCold(belowCelsius: 5)
        ),
        ...
        Badge(
            ...
            category: .weather,
            trigger: .sessionInSunshine(count: 5)
        ),
        ...
        Badge(
            ...
            category: .weather,
            trigger: .sessionAfterRain
        ),

        Badge(
            slug: "efteraarsloeber",
            name: "Efterårsløber",
            description: "Løb en tur i blade og efterårsvejr",
            category: .weather,
            trigger: .sessionInAutumn
        ),
        ...
        Badge(
            ...
            category: .habits,
            trigger: .addedJournalNote(afterSessions: 1)
        ),

        Badge(
            slug: "musik-i-oererne",
            name: "Musik i ørerne",
            description: "Løb en tur med musik eller podcast",
            category: .habits,
            trigger: .sessionWithAudio
        ),
        ...
        Badge(
            ...
            category: .habits,
            trigger: .stretchedAfterSession(count: 3)
        ),
        ...
        Badge(
            ...
            category: .habits,
            trigger: .drankWaterBeforeAndAfter(count: 5)
        ),
        ...
        Badge(
            ...
            category: .habits,
            trigger: .preparedGearNightBefore
        ),
        ...
        Badge(
            ...
            category: .social,
            trigger: .returnedAfterPause(minDays: 14)
        ),
        ...
        Badge(
            ...
            category: .special,
            trigger: .sessionFirstWeekOfJanuary
        ),
        ...
        Badge(
            ...
            category: .special,
            trigger: .sessionWithNewPlaylist
        ),
    ]
}
