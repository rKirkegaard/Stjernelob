...
final class BadgesViewModel {
    ...
    private static let milestoneGroups: [[Badge]] = [
        [.interval5, .interval10, .interval15, .interval20, .interval25, .interval30, .interval40, .interval50, .interval75, .interval100, .interval150, .interval200, .interval300, .interval500, .interval750, .interval1000],
        [.sessionFourIntervals, .sessionSixIntervals, .sessionEightIntervals],
        [.runs1, .runs3, .runs5, .runs10, .runs15, .runs20, .runs25, .runs30, .runs40, .runs50, .runs60, .runs75, .runs80, .runs100],
