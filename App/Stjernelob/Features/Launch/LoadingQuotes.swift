...
enum LoadingQuotes {
    static let all: [LocalizedStringResource] = [
        ...
        .init(
            "loading.quote.8",
            defaultValue: "Vejrudsigten er tjekket. Dine ben er klare. Og du er modigere end du tror 🌤️"
        ),
        .init(
            "loading.quote.9",
            defaultValue: "Løberuten er varmet op og venter tålmodigt på dig 🗺️"
        ),
        .init(
            "loading.quote.10",
        ...
        .init(
            "loading.quote.16",
            defaultValue: "Pusler din rute på plads... spoiler: det bedste er frisk luft i lungerne 🌬️"
        ),
        .init(
            "loading.quote.17",
